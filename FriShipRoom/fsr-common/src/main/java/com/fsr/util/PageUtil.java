...
import com.fsr.exception.ParameterIllegalException;
...
public class PageUtil {
     ...
     */
    public static int calculateTotalPage(Long rowCount, int perPage) {
        return (rowCount % perPage == 0) ? (rowCount.intValue() / perPage) : (rowCount.intValue() / perPage + 1);
    }
